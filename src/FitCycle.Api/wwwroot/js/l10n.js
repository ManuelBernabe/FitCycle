...
const Strings = {
  ...
  ChangeImage:            { es: 'Cambiar imagen',                                     en: 'Change image',                          fr: "Changer l'image" },
  ...
  PrefilledNone:          { es: 'No hay registros anteriores para este día',           en: 'No previous workouts for this day',     fr: 'Pas d’entraînements précédents pour ce jour' },
  RestoreFromLastWorkout: { es: '↺ Restaurar pesos del último entrenamiento',          en: '↺ Restore weights from last workout',    fr: '↺ Restaurer les poids du dernier entraînement' },
  RestoredFromLast:       { es: 'Restaurado del {0}: {1} pesos. Recuerda pulsar Guardar.', en: 'Restored from {0}: {1} weights. Remember to press Save.', fr: 'Restauré du {0} : {1} poids. N’oubliez pas d’enregistrer.' },
  AutoPopulateImagesTitle:   { es: 'Auto-poblar imágenes con IA',                       en: 'Auto-populate images with AI',          fr: 'Remplir images avec IA' },
  AutoPopulateImagesDesc:    { es: 'La IA mapeará cada ejercicio sin imagen real a uno del catálogo wger.de.', en: 'AI will map each exercise without a real image to one in the wger.de catalog.', fr: 'L’IA associera chaque exercice sans image réelle à un du catalogue wger.de.' },
  AutoPopulateImagesBtn:     { es: '🤖 Buscar imágenes con IA',                          en: '🤖 Find images with AI',                fr: '🤖 Chercher images avec IA' },
  AutoPopulateImagesRunning: { es: '🤖 Procesando...',                                   en: '🤖 Processing...',                      fr: '🤖 En cours...' },
  AutoPopulateImagesDone:    { es: '✅ {0} ejercicios actualizados con imágenes',         en: '✅ {0} exercises updated with images',  fr: '✅ {0} exercices mis à jour avec images' },
  AutoPopulateImagesConfirm: { es: '¿Lanzar el proceso de auto-poblar imágenes? Usará tu cuota de IA.', en: 'Run the auto-populate images process? Will use AI quota.', fr: 'Lancer le processus de remplissage automatique d’images ? Utilisera votre quota IA.' },
  ...
  PdfFileUnreadable: { es: 'No se pudo leer el archivo. Vuelve a tocar "Seleccionar archivo" y elígelo de nuevo (si está en iCloud, ábrelo antes en la app Archivos).', en: 'Could not read the file. Tap "Choose file" and pick it again (if it lives in iCloud, open it in the Files app first).', fr: "Impossible de lire le fichier. Appuyez sur « Choisir un fichier » et sélectionnez-le à nouveau (s'il est dans iCloud, ouvrez-le d'abord dans l'app Fichiers)." },
  ...
  CalendarTitle:   { es: 'Calendario',                            en: 'Calendar',                        fr: 'Calendrier' },
  CalendarSubtitle:{ es: 'Tus entrenamientos del mes',            en: 'Your workouts this month',        fr: 'Vos entraînements du mois' },
  PreviousMonth:   { es: 'Mes anterior',                           en: 'Previous month',                  fr: 'Mois précédent' },
  NextMonth:       { es: 'Mes siguiente',                          en: 'Next month',                      fr: 'Mois suivant' },
  WorkoutDone:     { es: 'Entrenado',                              en: 'Worked out',                      fr: 'Entraîné' },
  Today:           { es: 'Hoy',                                    en: 'Today',                           fr: 'Aujourd\'hui' },
  DaysActive:      { es: 'días activos',                           en: 'active days',                     fr: 'jours actifs' },
  AchievementsTitle:{ es: 'Logros',                                 en: 'Achievements',                    fr: 'Réussites' },
  ProgressionSuggest:{ es: '↑ Sube {0} kg ({1} kg)',                en: '↑ Add {0} kg ({1} kg)',           fr: '↑ Ajouter {0} kg ({1} kg)' },
  ProgressionTooltip:{ es: 'Completaste todas las series. Sube el peso.', en: 'You completed all sets. Time to add weight.', fr: 'Toutes les séries terminées. Augmentez le poids.' },
  Demo:            { es: 'Demo',                                   en: 'Demo',                            fr: 'Démo' },
  NoVideoForExercise:{ es: 'No hay vídeo configurado',             en: 'No video configured',             fr: 'Aucune vidéo configurée' },
  YouTubeUrlLabel: { es: 'URL de YouTube',                         en: 'YouTube URL',                     fr: 'URL YouTube' },
  Close:           { es: 'Cerrar',                                  en: 'Close',                           fr: 'Fermer' },
  ExportCsv:       { es: 'Exportar entrenamientos (CSV)',          en: 'Export workouts (CSV)',           fr: 'Exporter entraînements (CSV)' },
  FormTips:        { es: 'Consejos',                                en: 'Tips',                            fr: 'Conseils' },
  Technique:       { es: 'Técnica',                                  en: 'Technique',                       fr: 'Technique' },
  CommonError:     { es: 'Error común',                              en: 'Common mistake',                  fr: 'Erreur courante' },
  Breathing:       { es: 'Respiración',                              en: 'Breathing',                       fr: 'Respiration' },
  BodyComposition: { es: 'Composición corporal',                    en: 'Body composition',                fr: 'Composition corporelle' },
  LeanMass:        { es: 'Masa magra',                               en: 'Lean mass',                       fr: 'Masse maigre' },
  FatMass:         { es: 'Masa grasa',                               en: 'Fat mass',                        fr: 'Masse grasse' },
  Next:            { es: 'Siguiente',                                en: 'Next',                            fr: 'Suivant' },
  OnbWelcomeTitle: { es: '¡Bienvenido a FitCycle!',                 en: 'Welcome to FitCycle!',            fr: 'Bienvenue sur FitCycle !' },
  OnbWelcomeDesc:  { es: 'Configura tu perfil en 4 pasos para personalizar tu experiencia.', en: 'Set up your profile in 4 steps to personalize your experience.', fr: 'Configurez votre profil en 4 étapes pour une expérience personnalisée.' },
  OnbStart:        { es: 'Empezar',                                  en: 'Start',                           fr: 'Commencer' },
  OnbSkip:         { es: 'Saltar configuración',                     en: 'Skip setup',                      fr: 'Passer la configuration' },
  OnbGoalTitle:    { es: '¿Cuál es tu objetivo?',                    en: 'What is your goal?',              fr: 'Quel est votre objectif ?' },
  OnbGoalDesc:     { es: 'Esto nos ayuda a sugerirte rutinas y progresiones.', en: 'This helps us suggest routines and progressions.', fr: 'Cela nous aide à suggérer des routines et des progressions.' },
  OnbLevelTitle:   { es: '¿Cuál es tu nivel?',                       en: 'What is your level?',             fr: 'Quel est votre niveau ?' },
  OnbLevelDesc:    { es: 'Ajustaremos los descansos y las cargas sugeridas.', en: 'We\'ll adjust rest times and suggested loads.', fr: 'Nous ajusterons les temps de repos et les charges suggérées.' },
  OnbDaysTitle:    { es: '¿Cuántos días entrenas?',                  en: 'How many days do you train?',     fr: 'Combien de jours entraînez-vous ?' },
  OnbDaysDesc:     { es: 'Te ayudará a planificar la rutina semanal.', en: 'Helps us plan your weekly routine.', fr: 'Cela aide à planifier votre routine hebdomadaire.' },
  OnbDaysShort:    { es: 'días',                                     en: 'days',                            fr: 'jours' },
  OnbReadyTitle:   { es: '¡Todo listo!',                             en: 'All set!',                        fr: 'Tout est prêt !' },
  OnbReadyDesc:    { es: 'Podemos generar tu primera rutina automáticamente con IA, o puedes empezar de cero.', en: 'We can generate your first routine automatically with AI, or you can start from scratch.', fr: 'Nous pouvons générer votre première routine automatiquement avec l\'IA, ou commencez de zéro.' },
  OnbGenerate:     { es: 'Generar mi rutina con IA',                 en: 'Generate my routine with AI',     fr: 'Générer ma routine avec IA' },
  OnbFinishNoGen:  { es: 'Empezar desde cero',                       en: 'Start from scratch',              fr: 'Commencer de zéro' },
  OnbGenerateDone: { es: 'Rutina sugerida. Revísala en la pestaña IA y aplícala si te gusta.', en: 'Routine suggested. Review it on the AI tab and apply if you like it.', fr: 'Routine suggérée. Vérifiez-la dans l\'onglet IA et appliquez si vous l\'aimez.' },
  ...
  // === AI Assistant ===
  TabAI:               { es: 'IA',                                       en: 'AI',                                fr: 'IA' },
  AIAssistant:         { es: 'Asistente IA',                             en: 'AI Assistant',                      fr: 'Assistant IA' },
  AIAnalysis:          { es: 'Análisis',                                 en: 'Analysis',                          fr: 'Analyse' },
  AIGenerate:          { es: 'Generar Rutina',                           en: 'Generate Routine',                  fr: 'Générer Routine' },
  AISuggest:           { es: 'Sugerencias',                              en: 'Suggestions',                       fr: 'Suggestions' },
  AIThinking:          { es: 'La IA está analizando...',                 en: 'AI is analyzing...',                fr: "L'IA analyse..." },
  AINoData:            { es: 'No hay datos suficientes',                 en: 'Not enough data',                   fr: 'Pas assez de données' },
  AIError:             { es: 'Error al consultar la IA',                 en: 'AI query error',                    fr: "Erreur de requête IA" },
  AISummary:           { es: 'Resumen',                                  en: 'Summary',                          fr: 'Résumé' },
  AIStrengths:         { es: 'Puntos Fuertes',                           en: 'Strengths',                        fr: 'Points Forts' },
  AIImprovements:      { es: 'Áreas de Mejora',                          en: 'Areas to Improve',                  fr: "Axes d'Amélioration" },
  AIPlateaus:          { es: 'Mesetas Detectadas',                       en: 'Plateaus Detected',                 fr: 'Plateaux Détectés' },
  AIRecommendations:   { es: 'Recomendaciones',                          en: 'Recommendations',                   fr: 'Recommandations' },
  AIConsistency:       { es: 'Consistencia Semanal',                     en: 'Weekly Consistency',                fr: 'Régularité Hebdomadaire' },
  AIMuscleBalance:     { es: 'Balance Muscular',                         en: 'Muscle Balance',                    fr: 'Équilibre Musculaire' },
  AIGenerateTitle:     { es: 'Generar Rutina con IA',                    en: 'AI Routine Generator',              fr: 'Générateur de Routine IA' },
  AIGoal:              { es: 'Objetivo',                                  en: 'Goal',                              fr: 'Objectif' },
  AIGoalHypertrophy:   { es: 'Hipertrofia',                              en: 'Hypertrophy',                       fr: 'Hypertrophie' },
  AIGoalStrength:      { es: 'Fuerza',                                   en: 'Strength',                          fr: 'Force' },
  AIGoalEndurance:     { es: 'Resistencia',                              en: 'Endurance',                         fr: 'Endurance' },
  AIGoalFatLoss:       { es: 'Pérdida de grasa',                         en: 'Fat Loss',                          fr: 'Perte de graisse' },
  AIGoalGeneral:       { es: 'Fitness general',                          en: 'General Fitness',                   fr: 'Fitness général' },
  AILevel:             { es: 'Nivel',                                     en: 'Level',                             fr: 'Niveau' },
  AILevelBeginner:     { es: 'Principiante',                              en: 'Beginner',                          fr: 'Débutant' },
  AILevelIntermediate: { es: 'Intermedio',                                en: 'Intermediate',                      fr: 'Intermédiaire' },
  AILevelAdvanced:     { es: 'Avanzado',                                  en: 'Advanced',                          fr: 'Avancé' },
  AIDays:              { es: 'Días por semana',                           en: 'Days per week',                     fr: 'Jours par semaine' },
  AIEquipment:         { es: 'Equipamiento',                              en: 'Equipment',                         fr: 'Équipement' },
  AIEquipmentPlaceholder: { es: 'Ej: Gimnasio completo, solo mancuernas...', en: 'E.g.: Full gym, dumbbells only...', fr: 'Ex: Salle complète, haltères uniquement...' },
  AINotes:             { es: 'Notas adicionales',                         en: 'Additional notes',                  fr: 'Notes supplémentaires' },
  AINotesPlaceholder:  { es: 'Ej: Lesión de hombro, preferencia por...', en: 'E.g.: Shoulder injury, prefer...',  fr: 'Ex: Blessure épaule, préférence...' },
  AIGenerateBtn:       { es: 'Generar Rutina',                            en: 'Generate Routine',                  fr: 'Générer Routine' },
  AISuggestTitle:      { es: 'Búsqueda Inteligente',                     en: 'Smart Search',                     fr: 'Recherche Intelligente' },
  AISuggestLabel:      { es: 'Pregunta sobre ejercicios',                en: 'Ask about exercises',               fr: 'Demander sur les exercices' },
  AISuggestPlaceholder:{ es: 'Ej: alternativas a press banca, ejercicios para espalda baja...', en: 'E.g.: bench press alternatives, lower back exercises...', fr: 'Ex: alternatives au développé couché...' },
  AISuggestBtn:        { es: 'Buscar',                                    en: 'Search',                            fr: 'Rechercher' },
  AISuggestions:       { es: 'Sugerencias',                               en: 'Suggestions',                       fr: 'Suggestions' },
  ...
  // AI Tutorial
  TutAITitle:          { es: 'Asistente IA',                              en: 'AI Assistant',                      fr: 'Assistant IA' },
  TutAIDesc:           { es: 'Usa inteligencia artificial para mejorar tus entrenamientos con análisis, generación de rutinas y sugerencias.', en: 'Use AI to improve your workouts with analysis, routine generation, and suggestions.', fr: "Utilisez l'IA pour améliorer vos entraînements avec analyse, génération de routines et suggestions." },
  TutAIAnalysis:       { es: 'Análisis de progreso',                      en: 'Progress Analysis',                 fr: 'Analyse de progression' },
  TutAIAnalysisDesc:   { es: 'La IA analiza tus últimas 8 semanas y detecta fortalezas, mesetas y áreas de mejora', en: 'AI analyzes your last 8 weeks and detects strengths, plateaus, and areas for improvement', fr: "L'IA analyse vos 8 dernières semaines et détecte forces, plateaux et axes d'amélioration" },
  TutAIGenerate:       { es: 'Generar rutina',                            en: 'Generate Routine',                  fr: 'Générer routine' },
  TutAIGenerateDesc:   { es: 'Crea una rutina semanal personalizada según tu objetivo, nivel y días disponibles', en: 'Create a personalized weekly routine based on your goal, level, and available days', fr: 'Créez une routine hebdomadaire personnalisée selon votre objectif, niveau et jours disponibles' },
  TutAISuggest:        { es: 'Sugerencias de ejercicios',                 en: 'Exercise Suggestions',              fr: "Suggestions d'exercices" },
  TutAISuggestDesc:    { es: 'Pregunta sobre alternativas, ejercicios para grupos específicos o cualquier duda', en: 'Ask about alternatives, exercises for specific muscle groups, or any question', fr: 'Demandez des alternatives, exercices pour groupes spécifiques ou toute question' },
  TutAITip:            { es: 'El asistente IA usa tu historial real para darte consejos personalizados. Cuantos más entrenamientos registres, mejores serán las recomendaciones.', en: 'The AI assistant uses your real history for personalized advice. The more workouts you log, the better the recommendations.', fr: "L'assistant IA utilise votre historique réel pour des conseils personnalisés. Plus vous enregistrez d'entraînements, meilleures sont les recommandations." },
