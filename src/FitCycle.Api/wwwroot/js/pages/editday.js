      ...
      <div style="margin-bottom:8px;border:1px solid ${isInSuperset ? '#e67e22' : '#eee'};border-radius:8px;padding:6px;">
        <div style="display:flex;align-items:center;gap:4px;">
          ...
          <div style="display:flex;flex-direction:column;gap:2px;flex-shrink:0;">
            ...
            <button class="btn-move-ex" data-gi="${gi}" data-ei="${ei}" data-dir="down" style="background:#f3f0fc;border:none;color:#512BD4;font-size:16px;cursor:pointer;padding:2px 6px;line-height:1;border-radius:4px;${ei === group.exercises.length - 1 ? 'visibility:hidden;' : ''}" title="${t('MoveDown')}">&#9660;</button>
          </div>
          ${supersetBtn}
...
async function showCustomNamePrompt(group, displayName) {
  const name = await showPrompt(t('ExerciseNameFor', displayName));
